...
const ClientComponent: React.FC<ClientComponentProps> = ({
  ...
  return (
    <div className="flex w-full flex-col gap-2">
      ...
      {/* PDF Viewer Modal */}
      {selectedPdfUrl && (
        <div className="fixed inset-0 flex w-[100svw] h-[100svh] bg-[#0c0c0c] bg-opacity-50">
          <div className="relative w-[100svw]  h-[100svh] items-center justify-center rounded-lg bg-orange-600 ">
            <button
